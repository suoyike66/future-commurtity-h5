import type { ConfirmVo, ResultModel, ResultObjectVo } from '../result-model'
import RequestModel, { type AfterCheckFunction, DEFAULT_REQUEST_HEADER, type RequestConfig } from '../request-model'
import type { MaskConfig } from '@/utils/mask-util.ts'
import { confirmMethod, messageMethod } from '@/utils/message-util.ts'
